...
{
    x = clamp(x, 0.0, 1.0);
    return x < 0.5 ? ExponentialEaseIn(x * 2.0) / 2.0 : ExponentialEaseOut(x * 2.0 - 1.0) / 2.0 + 0.5;
}
...
{
    x = clamp(x, 0.0, 1.0);
    return x < 0.5 ? ExponentialEaseOut(x * 2.0) / 2.0 : ExponentialEaseIn(x * 2.0 - 1.0) / 2.0 + 0.5;
}
